...
int main(){
    Electronics e1(101, "Laptop", 1200, 2, "Dell");
    Clothing c1(201, "T-Shirt", 25, 'M', "Blue", "Cotton");
    FoodItem f1(301, "Apple", 2, "2025-05-10", 95);
    Book b1(401, "C++ Primer", 50, "Lippman", "Programming");
    ...
    c1.applyDiscount();
    cout << "New Clothing Price: " << c1.calculateTotalPrice(1) << "\n";

    cout << "\nBulk Purchase Total Price for 12 Apples: " << f1.calculateTotalPrice(12) << "\n";
