...
void average(int aqi[4][28], int days, double cityAvg[]){
    ...
    cout << "\nCity with the worst air quality: " << worstCity+1 << " (AQI: " << highest << ")\n";
}
...
void generateReport(int aqi[4][28], int days){
    ...
    cout << "\nComparison of Highest and Lowest AQI values:\n";
    for (int i = 0; i < 4; i++) {
...
int main() {
    ...
    cout << "Enter AQI value for a week:\n";
    input(aqi, 7);
    ...
    cout << "\nEnter AQI data for the full month:\n";
    input(aqi, 28);
    calMonthly(aqi);
